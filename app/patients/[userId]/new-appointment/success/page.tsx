...
const RequestSuccess = async ({
  ...
  const docs = doctors.documents.find(
    (doctor) => doctor.fullName === appointment.primaryPhysician
  );
      ...
      <div className="success-img">
        ...
        <section className="request-details text-white">
          ...
          <div className="flex items-center gap-3">
            <Image
              src={docs?.profilePictureUrl}
              alt="doctor"
              width={100}
              height={100}
              className="size-6"
            />
            <p className="whitespace-nowrap">Dr. {docs?.fullName}</p>
          </div>
